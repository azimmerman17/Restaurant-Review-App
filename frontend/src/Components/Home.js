...
const Home = () => {
    return (
        <div className='bg-white p-2 shadow rounded'>
            <img src='https://images.unsplash.com/photo-1549648184-0d3e8b8684fd?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80' alt='HomeImage' /> />
            <div>
